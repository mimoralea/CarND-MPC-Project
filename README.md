...
The delay of 100 ms makes things a little trickier, but knowing this artificial delay helps 
come up with good numbers for the timestep and duration. The best combination is:

  * N = 15
  * dt = 0.1

This combination allowed the vehicle to drive at about 45 mph constantly around the track.


## Polynomial Fitting and MPC Preprocessing

Just as in the samples, a polynomial order 3 works well fitting x and y.
